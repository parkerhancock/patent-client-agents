"""SQLite schema for the MPEP corpus.

One ``sections`` row per MPEP section (or appendix sub-part). The FTS5
...
META_KEYS = {
    ...
    "source_version": "MPEP version label as reported by eMPEP",
