...
| `scrapers/inpi_fr.py`  | French-language PDF (3 rights in one document)      | Landing-page discovery of the inpi-block download URL; curated catalog + French-ordinal annuity walker; 2nd-column pypdf dropouts on years 8-20 documented as a v1 GAP |
...
| INPI-FR | French-language PDF | none                          | EUR      | large/small (50% reduction) | Curated catalog + per-year annuity walker (French ordinals). Reduced rate reliably captured for years 2-7 only — pypdf drops the 2nd column for years 8-20. SPC at year=21. |
