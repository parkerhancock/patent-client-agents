...
| `get_file_history_item` | Fetch structured **text content** from XML or an embedded PDF text layer. Image-only PDFs are not OCRed. PDF bytes: use `download_file_history`. |
