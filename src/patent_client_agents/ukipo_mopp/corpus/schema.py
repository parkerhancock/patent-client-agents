"""SQLite schema for the MOPP corpus.

One ``sections`` row per MOPP section (or appendix sub-part). The FTS5
...
META_KEYS = {
    ...
    "source_version": "MOPP version label as reported by eMOPP",
