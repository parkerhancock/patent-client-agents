...
**Connector status:** **fees: planned** (official HTML tables and Resmî Gazete authority); **register: skipped until TÜRKPATENT publishes a supported API or bulk feed**
