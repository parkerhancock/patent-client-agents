...
106 patent + IP MCP tools are exposed by default. Private/local
deployments expose up to 171 tools when every env-gated family is
...
Expect 106 tools by default and up to 171 tools when every env-gated
