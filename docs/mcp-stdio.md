...
128 patent + IP MCP tools are exposed by default. Private/local
deployments expose up to 226 tools when every env-gated family is
...
Expect 128 tools by default and up to 226 tools when every env-gated
