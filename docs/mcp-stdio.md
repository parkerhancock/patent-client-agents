...
120 patent + IP MCP tools are exposed by default. Private/local
deployments expose up to 185 tools when every env-gated family is
...
Expect 120 tools by default and up to 185 tools when every env-gated
