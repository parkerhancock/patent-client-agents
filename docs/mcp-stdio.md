...
116 patent + IP MCP tools are exposed by default. Private/local
deployments expose up to 181 tools when every env-gated family is
...
Expect 116 tools by default and up to 181 tools when every env-gated
