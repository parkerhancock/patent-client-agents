...
131 patent + IP MCP tools are exposed by default. Private/local
deployments expose up to 229 tools when every env-gated family is
...
Expect 131 tools by default and up to 229 tools when every env-gated
