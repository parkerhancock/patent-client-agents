...
126 patent + IP MCP tools are exposed by default. Private/local
deployments expose up to 191 tools when every env-gated family is
...
Expect 126 tools by default and up to 191 tools when every env-gated
