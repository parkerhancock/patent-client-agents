...
112 patent + IP MCP tools are exposed by default. Private/local
deployments expose up to 177 tools when every env-gated family is
...
Expect 112 tools by default and up to 177 tools when every env-gated
