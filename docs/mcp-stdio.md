...
134 patent + IP MCP tools are exposed by default. Private/local
deployments expose up to 232 tools when every env-gated family is
...
Expect 134 tools by default and up to 232 tools when every env-gated
