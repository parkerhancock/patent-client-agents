...
which remains the shipped-coverage manifest until migration is approved.
...
The current implementation is a Japan, China, and South Korea pilot. It is not
yet an exhaustive worldwide inventory and does not replace the existing
coverage or research manifests.
