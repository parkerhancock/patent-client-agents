---
id: TH/DIP/Patents
name: Thailand DIP — Patents and Petty Patents
jurisdictions:
- TH
...
coverage:
  ...
  category: registered_ip
  transport: mcp_proxy
  notes: Tested with synthetic JSON fixtures derived from the official DIP Data Exchange catalogue; live
    account compatibility is unverified. The catalogue does not expose a usable OpenAPI document. Private
    BYOK only.
---

# Thailand DIP — Patents and Petty Patents

## What this source contains

Department of Intellectual Property, Thailand publishes this data product for patent. The compatibility
...
Tested with synthetic JSON fixtures derived from the official DIP Data Exchange catalogue; live account compatibility is unverified. The catalogue does not expose a usable OpenAPI document. Private BYOK only.
