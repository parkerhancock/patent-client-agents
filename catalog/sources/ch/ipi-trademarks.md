...
name: Swiss IPI — National Trademarks (Swissreg datadelivery)
jurisdictions:
- CH
...
coverage:
  ...
  notes: Schema-tested with synthetic XML fixtures derived from public IPI XSDs; live account compatibility
    is unverified. Signed Terms of Use and an IPI account are required. Optional MFA uses IPI_DATA_TOTP_TOKEN.
    Community validation and sanitized response samples are welcome.
---

# Swiss IPI — National Trademarks (Swissreg datadelivery)

## What this source contains

Swiss Federal Institute of Intellectual Property publishes this data product for trademark. The compatibility
...
Schema-tested with synthetic XML fixtures derived from public IPI XSDs; live account compatibility is unverified. Signed Terms of Use and an IPI account are required. Optional MFA uses IPI_DATA_TOTP_TOKEN. Community validation and sanitized response samples are welcome.
