...
name: PRV Sweden — National Trademarks
jurisdictions:
- SE
...
coverage:
  ...
  category: registered_ip
  transport: mcp_proxy
  notes: Nice classification; dossierTypeEn/Sv discriminates national filings from Madrid IRs designating
    SE. EUTM coverage via planned EUIPO connector.
---

# PRV Sweden — National Trademarks

## What this source contains

Patent- och registreringsverket (PRV) publishes this data product for trademark. The compatibility
...
Nice classification; dossierTypeEn/Sv discriminates national filings from Madrid IRs designating SE. EUTM coverage via planned EUIPO connector.
