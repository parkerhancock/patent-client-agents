---
id: AU/IPAustralia/Patents
name: IP Australia — Australian Patent Search
jurisdictions:
- AU
...
connector:
  status: shipped
  module: patent_client_agents.ip_australia_patents
  blockers: []
coverage:
  order: 15
  wipo_st3_code: AU
...
# IP Australia — Australian Patent Search
...
The compatibility connector module is `patent_client_agents.ip_australia_patents`. The catalog describes the
