...
name: IP Australia — Australian Trade Mark Search
jurisdictions:
- AU
...
connector:
  status: shipped
  module: patent_client_agents.ip_australia_trademarks
  blockers: []
coverage:
  order: 16
  wipo_st3_code: AU
...
# IP Australia — Australian Trade Mark Search

## What this source contains

IP Australia publishes this data product for trademark. The compatibility
...
The compatibility connector module is `patent_client_agents.ip_australia_trademarks`. The catalog describes the
