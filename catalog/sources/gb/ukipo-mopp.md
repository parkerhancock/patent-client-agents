---
id: GB/UKIPO/MoPP
name: UKIPO Manual of Patent Practice (MoPP)
jurisdictions:
- GB
...
connector:
  status: shipped
  module: patent_client_agents.ukipo_mopp
  blockers: []
coverage:
  order: 37
  wipo_st3_code: GB
...
The compatibility connector module is `patent_client_agents.ukipo_mopp`. The catalog describes the
...
- [Official source](https://www.gov.uk/guidance/manual-of-patent-practice-mopp)
