...
name: DPMA Germany — National Trademarks (DPMAconnectPlus)
jurisdictions:
- DE
...
coverage:
  ...
  notes: Mock-only tested with synthetic namespace-bearing XML fixtures; live compatibility is unverified.
    Basic Auth and a registered static IP are required. Private BYOK only. Community validation and sanitized
    response samples are welcome.
---

# DPMA Germany — National Trademarks (DPMAconnectPlus)

## What this source contains

Deutsches Patent- und Markenamt publishes this data product for trademark. The compatibility
...
Mock-only tested with synthetic namespace-bearing XML fixtures; live compatibility is unverified. Basic Auth and a registered static IP are required. Private BYOK only. Community validation and sanitized response samples are welcome.
