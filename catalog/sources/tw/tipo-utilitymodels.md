...
name: TIPO Taiwan — Utility Models
jurisdictions:
- TW
...
coverage:
  ...
  category: registered_ip
  transport: mcp_proxy
  notes: applclass=2; TW Article 32 invention/UM twins surface via /PatentTwins
---

# TIPO Taiwan — Utility Models

## What this source contains

Intellectual Property Office, Ministry of Economic Affairs (TIPO/MOEA) publishes this data product for patent. The compatibility
...
applclass=2; TW Article 32 invention/UM twins surface via /PatentTwins
