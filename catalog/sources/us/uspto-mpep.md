---
id: US/USPTO/MPEP
name: Manual of Patent Examining Procedure (MPEP)
jurisdictions:
- US
institution: U.S. Patent and Trademark Office
source_type: legal_corpus
official_url: https://mpep.uspto.gov/
...
The compatibility connector module is `patent_client_agents.mpep`. The catalog describes the
...
- [Official source](https://mpep.uspto.gov/)
