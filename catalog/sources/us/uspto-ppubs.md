...
official_url: https://ppubs.uspto.gov/pubwebapp/
...
The compatibility connector module is `patent_client_agents.uspto_publications`. The catalog describes the
...
- [Official source](https://ppubs.uspto.gov/pubwebapp/)
