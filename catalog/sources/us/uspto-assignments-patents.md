---
id: US/USPTO/Assignments/Patents
name: USPTO Patent Assignment Center
jurisdictions:
- US
...
# USPTO Patent Assignment Center
...
The compatibility connector module is `patent_client_agents.uspto_assignments`. The catalog describes the
