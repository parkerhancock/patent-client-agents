---
id: US/USPTO/Fees/Trademarks
name: USPTO Fee Schedule — Trademarks
jurisdictions:
- US
...
coverage:
  ...
  notes: Post-2025-rule shape (no entity tiers; paper-filing surcharges modeled via FeeCondition(trigger=paper_filing)).
    37 CFR §§ 2.6, 2.7.
---

# USPTO Fee Schedule — Trademarks
...
Post-2025-rule shape (no entity tiers; paper-filing surcharges modeled via FeeCondition(trigger=paper_filing)). 37 CFR §§ 2.6, 2.7.
